...
public class C02_Cookies extends TestBase {
    ...
    public void test01() {
        ...
        Cookie cookie = new Cookie("en sevdğim cookie","cikolatali");
        ...
        // yok olduğunu test etmek için tüm cookie isimlerini kontrol edelim bir flag kullanıp
        // ismi skin olan varsa flag ı değiştirelim.
